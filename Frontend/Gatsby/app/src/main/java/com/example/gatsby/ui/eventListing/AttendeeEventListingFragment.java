...
public class AttendeeEventListingFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        eventListingModel = ViewModelProviders.of(this).get(EventListingModel.class);
        ...
        View1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                EventViewAttendeeFragment e = new EventViewAttendeeFragment();
        ...
        Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                RequestQueue requestQueue = Volley.newRequestQueue(root.getContext());
                try {
                    String url ="http://coms-309-mc-07.cs.iastate.edu:8080/events/attendee/"+ MyApplication.getUser().getId();
